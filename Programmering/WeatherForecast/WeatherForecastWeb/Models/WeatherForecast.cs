namespace WeatherForecastWeb.Models
{
	...
	public class Main
	{
		...
		{
			get { return _temp; }
			set { _temp = Math.Round(value - 272.15, 2); }
		}
		private double _feels_like;
		public double feels_like
		{
			get { return _feels_like; }
			set { _feels_like = Math.Round(value - 272.15, 2); }
		}
        ...
        public double temp_min
        {
            ...
            set { _temp_min = Math.Round(value - 272.15, 2); }
        }
        ...
        public double temp_max
        {
            ...
            set { _temp_max = Math.Round(value - 272.15, 2); }
        }
